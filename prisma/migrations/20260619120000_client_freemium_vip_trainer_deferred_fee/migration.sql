...
-- Trainer deferred registration fee
...
-- Payout withhold metadata on booked sessions
ALTER TABLE "booked_training_sessions" ADD COLUMN IF NOT EXISTS "payoutWithholdMetaJson" TEXT;
