...
ALTER TABLE "Trainer" ADD COLUMN IF NOT EXISTS "hiddenFromPublicMarketplace" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "Trainer" ADD COLUMN IF NOT EXISTS "platformBillingExempt" BOOLEAN NOT NULL DEFAULT false;
