...
| AT2 Ad Tracker phase 2 (Meta/Google API, CAPI, GA4, TikTok sync) | matchfit | **DISPATCHED** 2026-07-07 | Subagent | `cursor/ad-tracker-phase-2-df7f` |
| F1 RLS-8 (8 exposed tables) | matchfit | Open | Fable | `dispatch F1` |
