...
export const TRANSACTIONAL_EMAIL_KINDS = [
  ...
  "BETA_WAITLIST_TRAINER_VIRTUAL_CONFIRM",
  "BETA_WAITLIST_TRAINER_IN_PERSON_CONFIRM",
  "BETA_WAITLIST_CLIENT_CONFIRM",
  "BETA_WAITLIST_TRAINER_INVITE",
  "BETA_WAITLIST_TRAINER_VIRTUAL_CAPACITY",
  "BETA_WAITLIST_TRAINER_IN_PERSON_CAPACITY",
...
const TRANSACTIONAL_EMAIL_KIND_SAMPLE_LABELS: Record<TransactionalEmailKind, string> = {
  ...
  BETA_WAITLIST_TRAINER_VIRTUAL_CONFIRM: "Virtual trainer waitlist confirmation",
  BETA_WAITLIST_TRAINER_IN_PERSON_CONFIRM: "In-person trainer waitlist confirmation",
  BETA_WAITLIST_CLIENT_CONFIRM: "Client waitlist confirmation",
  BETA_WAITLIST_TRAINER_INVITE: "Trainer beta invite",
  BETA_WAITLIST_TRAINER_VIRTUAL_CAPACITY: "Virtual coach capacity opened",
  BETA_WAITLIST_TRAINER_IN_PERSON_CAPACITY: "In-person coach capacity opened",
