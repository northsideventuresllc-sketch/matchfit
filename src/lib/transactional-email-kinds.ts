...
const TRANSACTIONAL_EMAIL_KIND_SAMPLE_LABELS: Record<TransactionalEmailKind, string> = {
  ...
  BACKGROUND_CHECK_PLAN_B_INVITE_REQUEST: "Plan B — invite request (staff)",
  BACKGROUND_CHECK_PLAN_B_INVITE_SENT_TRAINER: "Plan B — Checkr invite sent",
  BACKGROUND_CHECK_PLAN_B_REVIEW: "Plan B — screening review (staff)",
