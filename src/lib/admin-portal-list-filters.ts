...
function launchClientUsernameEqualsExcludeOr(usernames: string[]): Prisma.ClientWhereInput[] {
  return usernames.map((username) => ({
    username: { equals: username, mode: "insensitive" as const },
  }));
}

function launchTrainerUsernameEqualsExcludeOr(usernames: string[]): Prisma.TrainerWhereInput[] {
  return usernames.map((username) => ({
    username: { equals: username, mode: "insensitive" as const },
  }));
}
...
function fakeClientOr(): Prisma.ClientWhereInput[] {
  return [
    ...
    ...launchClientUsernameEqualsExcludeOr(launchExcludeClientUsernamesExceptOwner()),
  ];
}
...
function fakeTrainerOr(): Prisma.TrainerWhereInput[] {
  ...
  return [
    ...
    ...launchTrainerUsernameEqualsExcludeOr(launchExcludeTrainerUsernamesExceptOwner()),
    ...certOr,
  ];
}
