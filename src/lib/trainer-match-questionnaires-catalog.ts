...
export const TRAINER_QUESTIONNAIRES_CATALOG: readonly TrainerQuestionnaireCatalogEntry[] = [
  {
    ...
    summary:
      "Session format preferences, in-person matching area, who you coach best, and your philosophy, used for discovery and algorithmic matching. Services and rates are managed from your dashboard.",
    disclaimer:
