  ...
  return JSON.stringify(
    {
      ...
      // Keep a stable aggregate field without depending on removed overview arrays.
      recentSignupCount: overview.memberOverview.pendingTrainers + overview.memberOverview.freeTrialClients,
    },
    null,
    2,
  );
