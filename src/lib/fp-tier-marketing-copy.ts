...
export const FP_SERVICE_CATALOGUE_DISCLAIMER =
  "This service catalogue applies to Match Fitness Pros and Elite Pros. Templates and checkout flows may differ by account type.";

export const FP_TIER_MARKETING_GROUPS: readonly FpTierMarketingGroup[] = [
  {
    id: "match_fit_pros",
    label: "Match Fitness Pros",
    description:
    ...
    tiers: [
      ...
      },
      {
        ...
        summary:
          "Everything in Match Fitness Pro plus premium discovery visibility, featured-placement programs, and optional Premium Page tools.",
        bullets: [
          "Everything included in Match Fitness Pro.",
...
export const FP_TIER_MARKETING_BETA_NOTE =
  "During beta, Match Fitness Pro is not offered at signup. Founding Fitness Pros start on Match Fit Premium Pro.";
