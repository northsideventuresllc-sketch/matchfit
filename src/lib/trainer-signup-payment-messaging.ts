...
export const TRAINER_SIGNUP_FLOW_OVERVIEW =
  `How Fitness Pro signup works: (1) enter your account details, (2) accept the Fitness Pro agreement — your account is created automatically, (3) choose your account type — Match Fit Premium Pro is complimentary for beta users for ${TRAINER_SIGNUP_PREMIUM_PROMO_DAYS} days; Independent Fitness Pro includes a ${TRAINER_SIGNUP_PREMIUM_PROMO_DAYS}-day free trial, then the ${trainerIndependentProSubscriptionLabel()} subscription keeps your account active; Elite Fitness Pro requires a paid subscription, (4) upload required documents for review, (5) authorize your signup fee and complete background screening. Confirm your email from your dashboard once you are signed in. You must begin onboarding within ${TRAINER_SIGNUP_ONBOARDING_BEGIN_DAYS} days of sign-up. Founding Fitness Pros receive ${trainerSignupPremiumPromoBenefitLabel()} at sign-up. ${TRAINER_SIGNUP_CANNOT_SELL_UNTIL_COMPLETE}`;
