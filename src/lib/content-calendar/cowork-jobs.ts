...
export async function queueMiniChromeAgentJob(args: { ids: string[]; title: string }): Promise<void> {
  ...
  const refreshAutomationScript =
    "curl -fsSL https://raw.githubusercontent.com/northsideventuresllc-sketch/matchfit/main/scripts/gemini-media-automation.mjs -o $HOME/nvg-gemini-automation/gemini-media-automation.mjs && curl -fsSL https://raw.githubusercontent.com/northsideventuresllc-sketch/matchfit/main/scripts/carousel-slide-prompts.mjs -o $HOME/nvg-gemini-automation/carousel-slide-prompts.mjs && curl -fsSL https://raw.githubusercontent.com/northsideventuresllc-sketch/matchfit/main/scripts/video-shot-prompts.mjs -o $HOME/nvg-gemini-automation/video-shot-prompts.mjs && curl -fsSL https://raw.githubusercontent.com/northsideventuresllc-sketch/matchfit/main/scripts/video-stitcher.mjs -o $HOME/nvg-gemini-automation/video-stitcher.mjs;";
