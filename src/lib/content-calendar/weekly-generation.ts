...
async function planWeek(args: {
  ...
  const system = [
    ...
    "Active 28-day archetype testing strategy (10 posts/week: 3 Generic Info, 4 UGC Avatar with Jordan Blake, 1 Cinematic Trailer Video, 2 Text):",
    "- Balance coverage across target audiences: Join the Team (recruitment/onboarding), Clients (athlete demand & VIP trial), and List With Us (directory listings).",
    "- Ensure themes align with daily market research, platform analytics, operator learnings, and current DPMO growth phase.",
    "Plan Monday–Friday. Each day gets a focused theme, a single target audience, an audience-correct CTA, and a plain-English `dpmoRationale` (1-2 sentences) stating BOTH how the day fits the current DPMO growth phase AND the strategy behind it (why this audience/angle now). No jargon, no internal codes — write it so a founder skims it and immediately gets the point.",
