...
export const FP_BETA_PREMIUM_PRO_STICKER =
  "60 DAYS OF PREMIUM FITNESS PRO FREE FOR BETA USERS";

export const FP_BETA_DEFAULT_TIER: FpAccountTier = "match_fit_premium_pro";

/**
 * During beta the first N Fitness Pro sign-ups who ask for Match Fit Fitness Pro are given Match Fit
 * Premium Pro instead (JB, 2026-08-04). The tier picker already hides the Match Fit Fitness Pro card
 ...
 *
 * Counts Fitness Pro sign-ups overall, not just those who asked for Match Fit Fitness Pro.
 */
 ...
 * the tiers that carry a monthly fee take payment at selection time, while Match Fit Fitness Pro still
...
/** Cards shown on signup tier step (beta hides complimentary Match Fit Fitness Pro). */
