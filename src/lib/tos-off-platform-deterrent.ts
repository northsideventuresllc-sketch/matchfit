...
export const OFF_PLATFORM_ELITE_TRAINER_CHAT_NOTICE =
  "Elite Fitness Pro may share business email addresses and external listing links in chat. Phone numbers and off-platform payment details are still not allowed.";
