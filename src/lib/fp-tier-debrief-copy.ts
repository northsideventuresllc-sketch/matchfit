...
export const FP_MATCH_FIT_PRO_DEBRIEF: FpDebriefSection = {
  ...
  title: "Match Fit Fitness Pro",
  blocks: [
    {
      title: "Fitness Pro Onboarding Fee",
      paragraphs: [
        "Match Fit Fitness Pros can pay the platform onboarding fee today or defer it and repay from future payouts within 60 days of completing onboarding.",
      ],
      bullets: [
