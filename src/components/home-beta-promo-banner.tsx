    ...
    >
      ...
      <div className="relative min-w-0 border-t border-[#FFD34E]/15 px-4 pb-4 pt-5 sm:px-7 sm:pb-7">
        ...
        <p className="mt-3 rounded-xl border border-white/[0.06] bg-white/[0.03] p-3 text-left text-xs leading-relaxed text-white/45 [overflow-wrap:anywhere] sm:text-[13px]">
          ...
          client account during beta. <span className="font-semibold text-white/60">In-person sessions</span> with
          coaches are launching first in the{" "}
          <span className="font-semibold text-white/60">Atlanta metro area</span> (within approximately 15–20 miles
          of downtown Atlanta). Virtual coaching and discovery are available wherever the product supports them.
        </p>
