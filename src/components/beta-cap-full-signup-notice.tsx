...
export function BetaCapFullSignupNotice({ role, waitlistHref, cap, count, slotsUsed }: BetaCapFullSignupNoticeProps) {
  ...
  const body = isClient
    ? "All founding client membership slots for this beta are taken. Anyone in the United States can still join the waitlist — we will email you a secure invite when a slot opens, usually within 30 days to complete sign-up."
    : "All Fitness Pro slots for the Atlanta metro beta are taken. Join the waitlist and we will email you when a coach slot opens.";
