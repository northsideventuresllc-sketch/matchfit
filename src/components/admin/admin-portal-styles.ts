...
export const adminPortalBackgroundLayers = {
  warmGlow:
    "pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(ellipse_120%_80%_at_50%_-20%,rgba(255,211,78,0.14),transparent_55%),radial-gradient(ellipse_90%_60%_at_100%_0%,rgba(255,126,0,0.1),transparent_50%),radial-gradient(ellipse_70%_50%_at_0%_100%,rgba(227,43,43,0.08),transparent_55%)]",
  topAccent:
    "pointer-events-none fixed inset-x-0 top-0 -z-10 h-[22rem] bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(255,126,0,0.14),transparent_55%)]",
  vignette:
    "pointer-events-none fixed inset-0 -z-10 bg-[linear-gradient(180deg,rgba(45,52,64,0.25)_0%,transparent_35%,transparent_70%,rgba(11,12,15,0.92)_100%)]",
} as const;
...
export const adminPortalCardClass =
  "rounded-2xl border border-white/[0.08] bg-[#12151C] shadow-[0_34px_90px_-50px_rgba(227,43,43,0.25)] max-md:[backdrop-filter:none] md:bg-[#12151C]/75 md:backdrop-blur-xl";
