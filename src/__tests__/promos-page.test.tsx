...
describe("promos page", () => {
  ...
  it("renders product version and updated beta-reach copy", async () => {
    ...
    expect(html).toContain("requires a service ZIP in our Atlanta metro in-person launch area");
    expect(html).toContain("Client sign-up is open to valid U.S. ZIP codes nationwide during beta.");
