...
describe("fp-tier-marketing-copy", () => {
  ...
  it("scopes the service catalogue disclaimer to Match Fit Fitness Pros and Elite Pros", () => {
    expect(FP_SERVICE_CATALOGUE_DISCLAIMER).toMatch(/Match Fit Fitness Pros and Elite Pros/i);
  });
});
