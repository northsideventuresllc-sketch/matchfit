...
describe("trainer-signup-promo-copy", () => {
  it("promotes fully covered background checks for Match Fit Fitness Pro and Premium Pro", () => {
    expect(trainerFoundingBgCheckEligibleTiersLabel()).toContain("Match Fit Fitness Pro");
