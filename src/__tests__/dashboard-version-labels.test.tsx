...
const EMPTY_OVERVIEW: AdminPortalOverview = {
  ...
  finances: {
    ...
    clientsInVipTrial: 0,
    clientsInLegacyStripeTrial: 0,
    freePlanClients: 0,
    activeVipSubscriptions: 0,
    legacyPlatformSubscriptions: 0,
