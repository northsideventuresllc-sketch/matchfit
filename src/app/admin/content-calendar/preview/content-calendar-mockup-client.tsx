...
const DEMO_HUB: ClientContentPost[] = [
  {
    ...
    caption: "Atlanta trainers — beta spots are filling. Match Fit puts serious coaches in front of athletes ready to book.",
    visualPrompt: "Dark #07080C hero, orange #FF7E00 accent, trainer in ATL skyline.",
    hashtags: ["MatchFit", "ATLTrainers"],
    mediaUrl: null,
    mediaStatus: "none",
    posted: false,
    postedAt: null,
  ...
  },
  {
    ...
    dayIndex: 0,
    postType: "Video",
    targetGroup: "Virtual Clients",
    platforms: "Instagram Reels, TikTok",
    caption: "Swipe. Match. Train. Virtual clients discover coaches without cold DMs.",
    visualPrompt: "UGC-style phone screen showing Match Fit swipe UI.",
    hashtags: ["VirtualTraining", "MatchFit"],
    mediaUrl: null,
    mediaStatus: "none",
    posted: false,
    postedAt: null,
