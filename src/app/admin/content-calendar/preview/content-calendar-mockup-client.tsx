...
const DEMO_HUB: ClientContentPost[] = [
  {
    ...
    status: null,
    caption: "Join the Team — beta spots are filling. Match Fit puts serious coaches in front of athletes ready to book.",
    visualPrompt: "Dark #07080C hero, orange #FF7E00 accent, coach training client.",
  ...
  },
  {
    ...
    status: null,
    caption: "Swipe. Match. Train. Clients discover coaches without cold DMs.",
