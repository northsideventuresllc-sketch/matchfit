            ...
            <div className="rounded-3xl border border-white/[0.08] bg-[#12151C]/95 p-6 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.9)] backdrop-blur-xl sm:p-8">
              ...
              <form onSubmit={(e) => void handleLogin(e)} className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    spellCheck={false}
                    maxLength={24}
                    className="rounded-xl border border-white/[0.1] bg-[#07080c] px-4 py-3 font-mono text-sm tracking-wide text-white outline-none ring-[#FF7E00]/40 placeholder:text-white/25 focus:border-[#FF7E00]/35 focus:ring-2"
              ...
              />
                ...
                <button
                  type="submit"
                  disabled={busy}
                  className="group relative isolate mt-1 flex min-h-[3.25rem] w-full items-center justify-center overflow-hidden rounded-xl px-4 text-sm font-black uppercase tracking-[0.08em] text-[#0B0C0F] shadow-[0_20px_50px_-18px_rgba(255,126,0,0.35)] transition active:translate-y-px disabled:opacity-50"
                >
                  <span
                    aria-hidden
