              ...
              {profile?.registrationFeeWaived ? (
                <div className="rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-[13px] leading-relaxed text-emerald-100/95">
                  ...
                  <p className="mt-1 text-emerald-100/85">
                    ...
                    {trainerIndependentProSubscriptionLabel()} subscription keeps your account active. Begin onboarding
                    within {TRAINER_SIGNUP_ONBOARDING_BEGIN_DAYS} days of sign-up. You cannot sell services until every
