...
export const metadata: Metadata = {
  title: "FitHub Settings | Fitness Pro | Match Fit",
};
  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2 text-center">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#FF7E00]/90">Fitness Pro Personalization</p>
        <h1 className="text-3xl font-black tracking-[0.04em] sm:text-4xl">FitHub Settings</h1>
        <p className="mx-auto max-w-xl text-sm leading-relaxed text-white/50">
          Tune how your feed is ordered, which content types appear, and how aggressively repeated Fitness Pro posts are hidden.
        </p>
