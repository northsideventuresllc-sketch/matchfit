        ...
        <p className="mt-3 text-sm text-white/55">
          {signupHoldFlow ? (
            <>
              ...
              processing) and receive {trainerSignupPremiumPromoBenefitLabel()} of Independent Pro access at sign-up; after
              the trial, the {trainerIndependentProSubscriptionLabel()} subscription keeps your account active. Begin
