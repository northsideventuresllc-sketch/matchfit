      ...
      <div className="relative z-10 mx-auto max-w-lg px-5 py-12 sm:px-8">
        ...
        {error ? (
          ...
          <p className="mt-6 text-sm text-white/60">
            Redirecting to Stripe to connect your card and reactivate your Independent Pro account…
          </p>
        )}
      </div>
    </main>
...
export default function TrainerReactivateCheckoutPage() {
  return (
