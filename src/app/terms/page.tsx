    ...
    <main className="relative min-h-dvh overflow-x-hidden bg-[#0B0C0F] px-5 py-12 text-white sm:px-8">
      <div className="mf-prose-safe mx-auto max-w-2xl">
        ...
        <P>
          ...
          types (Match Fitness Pro, Match Fit Premium Pro, Independent Fitness Pro, and Elite Fitness Pro) described in Section
          11A.
        </P>
        <P>
        ...
        <Ul>
          ...
          <Li>
            ...
            messaging capabilities. <Strong>Match Fitness Pro</Strong> and <Strong>Match Fit Premium Pro</Strong> use
          ...
          <Li>
            ...
            Service does not require Fitness Pros to use Match Fit exclusively. For <Strong>Match Fitness Pro</Strong> and{" "}
        ...
        <Ul>
          <Li>
            <Strong>Match Fitness Pro:</Strong> No monthly platform fee for the tier itself. Includes in-app chat, Fit Hub,
          ...
          <Li>
            <Strong>Match Fit Premium Pro:</Strong> Includes everything in Match Fitness Pro plus premium discovery surfacing,
        ...
        <Ul>
          ...
          <Li>
            ...
            Service. For <Strong>Match Fitness Pro</Strong> and <Strong>Match Fit Premium Pro</Strong>, attempting to
        ...
        <P>
          ...
          Elite Fitness Pro includes unlimited nudges; Match Fitness Pro and Match Fit Premium Pro use chat instead of nudges.
