...
- **2026-08-12** `2.15.0-beta` → `2.16.0-beta` (**minor** — Forgot password (client/coach/admin), password-changed security notice with account auto-lock, admin account-support tool, stronger password policy)
