...
- **2026-09-07** `2.29.3-beta` → `2.29.4-beta` (**patch** — Cache trending-hashtag research (24h) so content generators skip the 120s web search and no longer 504 before writing posts)
