...
- **2026-06-09** `1.4.8-beta` → `1.4.9-beta` (**patch** — Fix duplicate signup hold key causing build failure)
- **2026-06-09** `1.4.7-beta` → `1.4.8-beta` (**patch** — Improve Outreach HQ AI lead quality and fix exclusion of soft-deleted trainers)
