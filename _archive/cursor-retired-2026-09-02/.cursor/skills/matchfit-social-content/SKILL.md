...
3. **Live promos** — For founding-member / beta caps / trial offers, align with `/promos` and `HomeBetaPromoBanner` messaging; do not contradict slot counts. Match Fit is worldwide — never frame availability by city, metro or country.
